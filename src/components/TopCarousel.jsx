...
// 常量配置
const CAROUSEL_IMAGES = ['imgs/carrerbg02.jpg', 'imgs/s2.jpg', 'imgs/s3.jpg', 'imgs/s4.jpg']
...
const ActionButton = (props) => (
  <button 
    class={`px-8 py-5 no-underline transition duration-300 ${props.classes}`}
          ...
          <div class="w-full max-w-[625px]">
            ...
            <div class="mt-10">
              <For each={[
                ...
                >
                  {({ text, classes, id }) => (
                    <button class={`px-8 py-5 no-underline transition rounded-full duration-300 ${classes}`} onClick={() => scrollToSection(id)}>
                      {text}
                    </button>
                  )}
                </For>
