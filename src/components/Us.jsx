...
import { useI18n } from '~/libs/i18n' // Make sure to import the useI18n hook
...
export default function ChooseUs() {
    ...
    return(
        <div class="bg-no-repeat bg-cover w-full relative bg-[url('imgs/WorlMap.png')]">
    ...
    return (
      <dl class="faq mx-auto max-w-2xl">
        <dt class="text-lg sm:mb-0">
          ...
          >
            <span class="text-lg font-normal text-stone-800">
              {item.question}
            </span>
        ...
        >
          <p class="pb-6 text-base text-stone-400">
            {item.answer}
          </p>
        </dd>
      </dl>
